...
function HomeForm() {
    ...
    const convert = async () => {
        ...
        try {
            ...
            const formattedForeignAmount = formatAmount(amount! / exchangeRate, currency);
    ...
    return (
        <>
            <Container>
                <form name="currencyExchangeForm" noValidate className="grid grid--3-cols">
                    ...
                    <Select
                        ...
                        required>
                        {CURRENCIES.map(currency => <SelectOption value={currency}>{currency}</SelectOption>)}
                    </Select>
                    <Button
                        onClick={convert}
